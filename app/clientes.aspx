<%@ Page Language="C#" AutoEventWireup="true" CodeFile="clientes.aspx.cs" Inherits="app_clientes" MasterPageFile="~/app/index.master" EnableEventValidation="false" %>
...
<asp:Content ContentplaceholderID="indexBodyPlaceholder" runat="server">
  ...
  <div class="mdl-grid card-box">
    ...
    <div class="cardCadastro hidden mdl-card mdl-shadow--4dp mdl-cell mdl-cell--12-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-grid" id="addCli">
      <div class="mdl-card__title mdl-cell mdl-cell--12-col">
      ...
      <div class="card-content mdl-grid mdl-cell mdl-cell--12-col-desktop mdl-cell--8-col-tablet mdl-cell--4-col-phone">
          ...
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell mdl-cell--3-col-dektop mdl-cell-4-col-phone">
  ...
  <script>
    ...
    window.onload = shellTitle.innerHTML = 'Clientes';
