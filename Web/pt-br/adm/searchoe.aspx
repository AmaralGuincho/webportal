...
<asp:Content ContentPlaceHolderID="cph" runat="server">
    ...
    <div class="container">
        <div class="pesquisa">
             ...
             <asp:Calendar ID="cldr" runat="server" NextPrevStyle-VerticalAlign="NotSet" SelectionMode="Day" BorderColor="#4B4B4B" DayHeaderStyle-BackColor="#CC3300" DayHeaderStyle-ForeColor="White" TitleStyle-BackColor="#177AC4" TitleStyle-ForeColor="White" BorderStyle="Solid" DayStyle-BorderStyle="None" SelectedDayStyle-BorderStyle="None" SelectedDayStyle-BackColor="#FF3300" Font-Underline="False" DayStyle-ForeColor="#666666" WeekendDayStyle-BorderStyle="None" TodayDayStyle-BorderStyle="None" TodayDayStyle-BorderColor="Yellow" DayStyle-BorderWidth="0" NextPrevStyle-BorderStyle="None" TitleStyle-BorderStyle="None" FirstDayOfWeek="Monday"></asp:Calendar>
        </div>
    </div>
